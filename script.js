document.addEventListener('DOMContentLoaded', () => {
    ...
    // Résout le problème du menu qui ne s'affiche pas sur mobile.
    // ==========================================================
    if (menuToggle && mainNav) {
        menuToggle.addEventListener('click', () => {
            // Ajoute/enlève la classe 'active' pour afficher/cacher le menu CSS
            mainNav.classList.toggle('active');

            const isExpanded = menuToggle.getAttribute('aria-expanded') === 'true' || false;
            menuToggle.setAttribute('aria-expanded', !isExpanded);
            
            // Met à jour l'icône de ☰ à ✖
    ...
    // C'est le correctif pour le menu déroulant principal.
    // ==========================================================
    if (dropdownToggle && settingsMenu && languageDropdown) {
        dropdownToggle.addEventListener('click', (event) => {
            ...
            // Ajoute/enlève la classe 'show' sur l'élément parent pour l'affichage
    ...
    // A. Le Dictionnaire de Traduction (Reste inchangé)
    const translations = {
    ...
    function translatePage(lang) {
        ...
        // 2. Traduction des listes (data-key)
        ...
        // 3. Cas spécial pour le lien email
        ...
        // 4. Sauvegarde la langue dans le stockage local
